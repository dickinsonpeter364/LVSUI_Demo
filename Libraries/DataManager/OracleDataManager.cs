...
namespace LVS3
{
    public class OracleDataManager : IDataManager
    {
        public string ErrorDesription { get => OracleDatabase.ErrorDesription; set => OracleDatabase.ErrorDesription = value; }
        ...
        {
            bool retVal = OracleDatabase.SaveAction1(message, title, lpn, username, method, refersto, operatottext, userreason);
            if (ErrorDesription.Trim() != "")
            {
                DataManagerSMEA = new SystemMessageEventArgs(ErrorDesription, "Data Access", (int)CriticalLevels.Red);
                DataManagerSMHO?.Invoke(DataManagerSMEA);
        ...
        public bool SummaryDataInspectionStart(string reel_lpn, string label_item, string usersaving, int stationid, bool cancellinginspection)
        {
            bool retVal = OracleLabelData.SummaryDataInspectionStart(reel_lpn, label_item, usersaving, stationid, cancellinginspection);
            if (ErrorDesription.Trim() != "")
            {
                DataManagerSMEA = new SystemMessageEventArgs(ErrorDesription, "Data Access", (int)CriticalLevels.Red);
                DataManagerSMHO?.Invoke(DataManagerSMEA);
        ...
        public bool SaveSummaryDataStart(string reel_lpn, string label_item, string usersaving, int stationid, DateTime started_at)
        {
        ...
        public bool SummaryDataInspectionFinish(string reel_lpn, string label_item, string usersaving, int lblcount, int missing, int accept, int reject, int acceptop, int rejectop, string opsummary)
        {
            bool retVal = OracleLabelData.SummaryDataInspectionFinish(reel_lpn, label_item, usersaving, lblcount, missing, accept, reject, acceptop, rejectop, opsummary);
            if (ErrorDesription.Trim() != "")
            {
                DataManagerSMEA = new SystemMessageEventArgs(ErrorDesription, "Data Access", (int)CriticalLevels.Red);
                DataManagerSMHO?.Invoke(DataManagerSMEA);
        ...
        {
            bool retVal = OracleLabelData.SaveResultData(lpn, lin, acceptedbyuser, backingnumber, selecteditems, operatorinfo, reasons, additionalinfo, labelindex);
            if (ErrorDesription.Trim() != "")
            {
                DataManagerSMEA = new SystemMessageEventArgs(ErrorDesription, "Data Access", (int)CriticalLevels.Red);
                DataManagerSMHO?.Invoke(DataManagerSMEA);
        ...
        {
            bool retVal = OracleLabelData.SaveLabelRegion(labelvar, stationid, labelitem, inspectlightareas, maxgray, minarea);
            if (ErrorDesription.Trim() != "")
            {
                DataManagerSMEA = new SystemMessageEventArgs(ErrorDesription, "Data Access", (int)CriticalLevels.Red);
                DataManagerSMHL?.Invoke(DataManagerSMEA);
        ...
        {
            bool retVal = OracleLabelData.SaveLabelData(inspectLightAreas, minarea, stationid, labelitem, variationroi, innerradius, cameragain, labeltype);
            if (ErrorDesription.Trim() != "")
            {
                DataManagerSMEA = new SystemMessageEventArgs(ErrorDesription, "Data Access", (int)CriticalLevels.Red);
                DataManagerSMHL?.Invoke(DataManagerSMEA);
